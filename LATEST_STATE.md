...
### Step 1 — 프론트엔드 프로젝트 생성 및 의존성 설치 [대기]

bootstrap-frontend.sh --apply --install-deps 실행 필요.

### Step 2 — Spring MVC SPA 라우팅 설정 [대기]

dispatcher-servlet.xml, SpaForwardController.java, ViewController.java 수정 필요.

### Step 3 — 초기 빌드 및 배포 확인 [대기]

npm run build 및 Tomcat 배포 확인 필요.
